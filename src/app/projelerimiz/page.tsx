...
const projects = [
  {
    icon: FiShield,
    title: "AKFEN Isparta Şehir Hastanesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 100,
    desc: "Isparta Şehir Hastanesinde 7/24 güvenlik hizmeti, hasta ve ziyaretçi yönlendirme ve acil müdahale koordinasyonu sağlıyoruz.",
    highlights: ["Hastane Güvenliği", "Ziyaretçi Kontrolü", "Acil Müdahale"],
  },
  {
    icon: FiShield,
    title: "AKFEN Eskişehir Şehir Hastanesi",
    location: "Eskişehir",
    scope: "Güvenlik Hizmeti",
    personnel: 84,
    desc: "Eskişehir Şehir Hastanesinde güvenlik, giriş-çıkış kontrolü ve hasta güvenliği hizmetlerini profesyonel kadromuzla yürütüyoruz.",
    highlights: ["Hastane Güvenliği", "Giriş-Çıkış Kontrolü", "7/24 Nöbet"],
  },
  {
    icon: FiShield,
    title: "AKFEN Tekirdağ Şehir Hastanesi",
    location: "Tekirdağ",
    scope: "Güvenlik Hizmeti",
    personnel: 62,
    desc: "Tekirdağ Şehir Hastanesinde tesis güvenliği, ziyaretçi yönetimi ve acil durum koordinasyonu hizmetleri sunuyoruz.",
    highlights: ["Tesis Güvenliği", "Ziyaretçi Yönetimi", "Acil Durum"],
  },
  {
    icon: FiUsers,
