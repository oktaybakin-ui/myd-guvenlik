...
const projects = [
  {
    icon: FiShield,
    title: "AKFEN Isparta Şehir Hastanesi Şantiyesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 100,
    desc: "Isparta Şehir Hastanesi şantiyesinde 7/24 güvenlik hizmeti, giriş-çıkış kontrolü ve saha güvenliği sağlıyoruz.",
    highlights: ["Şantiye Güvenliği", "Giriş-Çıkış Kontrolü", "7/24 Nöbet"],
  },
  {
    icon: FiShield,
    title: "AKFEN Eskişehir Şehir Hastanesi Şantiyesi",
    location: "Eskişehir",
    scope: "Güvenlik Hizmeti",
    personnel: 84,
    desc: "Eskişehir Şehir Hastanesi şantiyesinde güvenlik, giriş-çıkış kontrolü ve saha güvenliği hizmetlerini profesyonel kadromuzla yürütüyoruz.",
    highlights: ["Şantiye Güvenliği", "Giriş-Çıkış Kontrolü", "Saha Güvenliği"],
  },
  {
    icon: FiShield,
    title: "AKFEN Tekirdağ Şehir Hastanesi Şantiyesi",
    location: "Tekirdağ",
    scope: "Güvenlik Hizmeti",
    personnel: 62,
    desc: "Tekirdağ Şehir Hastanesi şantiyesinde tesis güvenliği, giriş-çıkış kontrolü ve saha koruma hizmetleri sunuyoruz.",
    highlights: ["Şantiye Güvenliği", "Saha Koruma", "Giriş-Çıkış Kontrolü"],
  },
  {
    icon: FiUsers,
  ...
  {
    icon: FiHome,
    title: "Ustampark-2 Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Ustampark-2 Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Ustampark-3 Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Ustampark-3 Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Metrocity Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Metrocity Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiShield,
    title: "Boğaziçi Koleji",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 3,
    desc: "Eğitim kurumunda öğrenci ve personel güvenliğini sağlayarak, okul giriş-çıkış kontrolü ve kampüs güvenliği hizmeti veriyoruz.",
  ...
  },
  {
    ...
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Fabrika tesisinde 7/24 güvenlik, giriş-çıkış kontrolü ve çevre güvenliği hizmetlerini profesyonel kadromuzla sağlıyoruz.",
    highlights: ["Tesis Güvenliği", "Giriş-Çıkış Kontrolü", "Çevre Güvenliği"],
  },
  {
    icon: FiShield,
    title: "Çokcanlar Tarım Makineleri",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Tarım makineleri tesisinde güvenlik, giriş-çıkış kontrolü ve tesis koruma hizmetlerini yürütüyoruz.",
    highlights: ["Tesis Güvenliği", "Giriş-Çıkış Kontrolü"],
  },
  {
    icon: FiShield,
    title: "Karikatür Kafe",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 2,
    desc: "İşletme güvenliği ve genel düzen hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["İşletme Güvenliği", "Genel Düzen"],
  },
  {
    icon: FiHome,
    title: "Hayat Ağacı Evleri",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Hayat Ağacı Evlerinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Ustam Gökçay Evleri",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Ustam Gökçay Evlerinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Metro Vizyon Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Metro Vizyon Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Serracity Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Serracity Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Metro Prestij Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Metro Prestij Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Metroklas Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Metroklas Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Koçal Yaşam Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 6,
    desc: "Koçal Yaşam Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Yeni Yaka Sitesi",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 4,
    desc: "Yeni Yaka Sitesinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Kadızade Konutları",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 3,
    desc: "Kadızade Konutlarında güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
  {
    icon: FiHome,
    title: "Kadızade Yaşam Evleri",
    location: "Isparta",
    scope: "Güvenlik Hizmeti",
    personnel: 3,
    desc: "Kadızade Yaşam Evlerinde güvenlik ve site yönetim danışmanlığı hizmetlerini profesyonel ekibimizle sağlıyoruz.",
    highlights: ["Site Güvenliği", "Yönetim Danışmanlığı"],
  },
];

const projectStats = [
  { value: 25, suffix: "", label: "Aktif Proje" },
