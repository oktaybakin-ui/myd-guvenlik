        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              className="text-gray-400 text-xl leading-[1.9] mb-14 max-w-lg"
            >
            ...
            >
              ...
              <a
                ...
                className="btn-outline inline-flex items-center gap-3 text-white font-medium px-10 py-5 rounded-full text-base"
              >
