      ...
      <div className="relative z-10 flex-1 flex items-center">
        <div className="w-full max-w-[1400px] mx-auto px-6 lg:px-12 pt-40 pb-20">
          ...
          <motion.div
            ...
            className="mb-10 bg-white/[0.04] backdrop-blur-sm border border-white/[0.08] rounded-2xl p-6 lg:p-8 space-y-4"
          >
            <p className="text-white text-lg lg:text-xl leading-relaxed">
              🎓 Isparta &amp; Burdur&apos;da Özel Güvenlik Eğitimlerinde <span className="text-red-light font-bold">Lider Kurum</span> — Temel, yenileme ve silah farkı eğitimlerinde uzman kadromuzla geleceğin güvenlik profesyonellerini yetiştiriyoruz. <a href="tel:+905069038502" className="text-white font-bold hover:text-red-light transition-colors">Isparta: 0 (506) 903 85 02</a> · <a href="tel:+905010723215" className="text-white font-bold hover:text-red-light transition-colors">Burdur: 0 (501) 072 32 15</a>
            </p>
            <p className="text-gray-200 text-lg lg:text-xl leading-relaxed">
              270&apos;i aşkın özel güvenlik görevlimiz ve entegre hizmet anlayışımızla kurumsal güvenliğinizi en üst düzeyde sağlıyoruz. <span className="text-white font-semibold">Güvenlik, güvenlik danışmanlığı ve profesyonel site yönetim danışmanlığı</span> alanlarında çözümler sunuyoruz.
            </p>
          </motion.div>
